...
let CatalogController = class CatalogController {
    ...
    findAll(categoria, statusCatalogo, prioridade, localCompraPlanejado, search) {
...
], CatalogController.prototype, "getSummary", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Query)('categoria')),
    __param(1, (0, common_1.Query)('statusCatalogo')),
    __param(2, (0, common_1.Query)('prioridade')),
    __param(3, (0, common_1.Query)('localCompraPlanejado')),
